...
class App(ctk.CTk):
    def __init__(self):
        ...
        # Label frame content
        self.label_title = ctk.CTkLabel(self.label_frame, text="Label Tab", font=ctk.CTkFont(size=24, weight="bold"))
        self.label_title.grid(row=0, column=0, padx=20, pady=20)
        
        self.label_content = ctk.CTkLabel(self.label_frame, text="This is the content of the Label tab.\nYou can add your interface elements here.")
        self.label_content.grid(row=1, column=0, padx=20, pady=20)
