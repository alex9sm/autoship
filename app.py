...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.label_frame = ctk.CTkFrame(self, corner_radius=0, fg_color="transparent")
        self.tracking_frame = ctk.CTkFrame(self, corner_radius=0, fg_color="transparent")
        
        # Set up the label frame with nested tabs
        self.setup_label_frame()
        
        # Tracking frame content
        self.tracking_title = ctk.CTkLabel(self.tracking_frame, text="Tracking Tab", font=ctk.CTkFont(size=24, weight="bold"))
        self.tracking_title.grid(row=0, column=0, padx=20, pady=20)
        
        self.tracking_content = ctk.CTkLabel(self.tracking_frame, text="This is the content of the Tracking tab.\nYou can add your tracking features here.")
        self.tracking_content.grid(row=1, column=0, padx=20, pady=20)
        
        # Set default tab
        self.show_label_frame()
        
    def setup_label_frame(self):
        """Set up the label frame with nested tabs for Template and Receiver"""
        # Label frame title
        self.label_title = ctk.CTkLabel(self.label_frame, text="Labels", font=ctk.CTkFont(size=24, weight="bold"))
        self.label_title.grid(row=0, column=0, padx=20, pady=(20, 10), sticky="w")
        
        # Create tabs frame for Template and Receiver
        self.label_tabs_frame = ctk.CTkFrame(self.label_frame)
    ...
    def save_template(self):
        ...
        template_data = {
            "uuid": "2268642b-f741-4430-a318-d3a970deb1af",
            ...
            "package": {
                "length": self.package_length_entry.get(),
                "width": self.package_width_entry.get(),
                "height": self.package_height_entry.get(),
                "weight": self.package_weight_entry.get(),
    ...
    def show_tracking_frame(self):
        ...
        self.tracking_frame.grid(row=0, column=1, sticky="nsew")
        # Update button colors to highlight active tab
